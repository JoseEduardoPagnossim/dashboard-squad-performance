...
1. Faça backup do projeto atual e preserve seu `js/config.js`.
2. No Supabase, abra **SQL Editor**.
3. Execute `supabase/migrations/MIGRACAO_V2.20.5.sql` uma única vez.
4. Depois publique os arquivos da V2.20.5 no GitHub Pages.
5. Não substitua seu `js/config.js` de produção.

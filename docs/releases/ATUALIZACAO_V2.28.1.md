...
## Banco de dados
Executar `supabase/migrations/MIGRACAO_V2.28.1.sql`. A migração cria `support_monthly_costs`. A tabela individual `support_technician_hourly_costs`, criada na V2.28.0, é preservada apenas como legado e não é utilizada pela nova tela.

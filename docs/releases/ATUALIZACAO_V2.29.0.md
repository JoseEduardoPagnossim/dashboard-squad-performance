...
## Banco de dados
Executar `supabase/migrations/MIGRACAO_V2.29.0.sql` antes de publicar o frontend. A migração cria `quality_financial_monthly`, com RLS restrita ao **Admin Geral** da organização.

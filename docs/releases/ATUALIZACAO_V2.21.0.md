...
Execute uma vez `supabase/migrations/MIGRACAO_V2.21.0.sql`.
...
1. Execute `supabase/migrations/MIGRACAO_V2.21.0.sql` no Supabase SQL Editor.
2. Publique os arquivos da V2.21.0 no GitHub Pages.
3. Preserve o `js/config.js` de producao.

...
## Antes de publicar
Execute uma única vez no **Supabase → SQL Editor** o arquivo `supabase/migrations/MIGRACAO_V2.11.0.sql`.
...
Mantenha o seu `js/config.js` atual. Substitua `index.html`, `js/app.js` e `css/styles.css`.

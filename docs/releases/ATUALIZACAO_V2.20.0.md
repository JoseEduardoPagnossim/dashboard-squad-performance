...
1. Faça backup do repositório atual e do `js/config.js` em produção.
2. Execute `supabase/migrations/MIGRACAO_V2.20.0.sql` no Supabase SQL Editor.
...
Publique o conteúdo de `dashboard-squad-performance-v2.20.0-atualizacao-github.zip` no repositório, mantendo o `js/config.js` atual.

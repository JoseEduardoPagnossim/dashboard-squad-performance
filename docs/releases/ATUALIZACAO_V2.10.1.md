...
Isso fazia, por exemplo, `Técnico Demo 01` de janeiro a julho e `Técnico Demo 01` de agosto serem tratados como duas séries distintas.
...
O `README.md` e este arquivo são apenas documentação. Mantenha seu `js/config.js` atual.

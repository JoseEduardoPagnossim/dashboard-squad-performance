...
`supabase/migrations/MIGRACAO_V2.26.0.sql`
...
2. Executar `supabase/migrations/MIGRACAO_V2.26.0.sql` no Supabase.
3. Publicar `index.html`, `css/styles.css` e `js/app.js` da V2.26.0 (ou o pacote completo).

...
`supabase/migrations/MIGRACAO_V2.27.0.sql`
...
1. Executar `supabase/migrations/MIGRACAO_V2.27.0.sql` no Supabase.
2. Publicar `index.html`, `js/app.js` e `css/styles.css` da V2.27.0.
3. Manter o `js/config.js` atual de produção.
4. Fazer `Ctrl + F5`.

...
`supabase/migrations/MIGRACAO_V2.28.0.sql`
...
1. Executar `supabase/migrations/MIGRACAO_V2.28.0.sql` no SQL Editor do Supabase.
2. Publicar `index.html`, `js/app.js` e `css/styles.css` da V2.28.0.
3. Manter o `js/config.js` atual da produção.

...
- Substituir os arquivos do frontend pelo pacote V2.20.4, preservando o `js/config.js` de produção.
...
Para Técnico Demo 01, com 173 atendimentos, 85 avaliações, média 4,94 e 49,13% avaliado, a pontuação resultante é **899,62**.

...
1. Faça backup do repositório e preserve o `js/config.js` de produção.
2. No Supabase > SQL Editor, execute `supabase/migrations/MIGRACAO_V2.25.0.sql`.
3. Suba os arquivos do ZIP `dashboard-squad-performance-v2.25.0-atualizacao-github.zip` no repositório.
4. Não substitua o `js/config.js`.

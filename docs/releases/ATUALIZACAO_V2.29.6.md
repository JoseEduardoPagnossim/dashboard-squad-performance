...
- Técnico Demo 01: `ACIMA` — 3/4
- Técnico Demo 02: `ABAIXO` — 1/4
- Técnico Demo 03: `ACIMA` — 2/4
- Técnico Demo 04: `ABAIXO` — 1/4
- Técnico Demo 05: `ACIMA` — 4/4
- Técnico Demo 06: `ACIMA` — 2/4
- Técnico Demo 07: `ACIMA` — 3/4
- Técnico Demo 08: `ACIMA` — 3/4

Na bonificação, com Diego marcado como competência parcial, somente Técnico Demo 04 gera o desconto de R$ 200. O pool fica em R$ 200 e é dividido entre os 6 técnicos `ACIMA` elegíveis, aproximadamente R$ 33,33 para cada um.

### 6. Banco

Execute `supabase/migrations/MIGRACAO_V2.29.6.sql` depois das migrações anteriores. Não há coluna ou tabela nova.
